...
const cosmiconfigExplorer = cosmiconfig("stylelint", cosmiconfigOptions)
...
export default function (options) {
  ...
  return cosmiconfigExplorer.load(null, options.configFile).then(result => {
  ...
  function loadExtendedConfig(config, configDir, extendLookup) {
    ...
    return cosmiconfigExplorer.load(null, extendPath).then(result => {
